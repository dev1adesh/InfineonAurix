...
/* LEDs */
#define LED1                        &MODULE_P20,7                          /* LED D107                             */
#define LED2                        &MODULE_P20,8                           /* LED D108                             */
...
void initSerialInterface(void)
{
    ...
    const IfxAsclin_Asc_Pins pins = {
            ...
            .rx         = &IfxAsclin2_RXC_P02_10_IN,         /* Select the pin for RX connected to the USB port      */ // module & pin??
            .rxMode     = IfxPort_InputMode_pullUp,         /* RX pin                                               */
            .rts        = NULL_PTR,                         /* RTS pin not used                                     */
            .rtsMode    = IfxPort_OutputMode_pushPull,
            .tx         = &IfxAsclin2_TX_P02_9_OUT,         /* Select the pin for TX connected to the USB port      */ // module & pin??
