...
#define CAN_MESSAGE_RX_ID           (uint32)0x666           /* Message ID that will be used in arbitration phase    */
#define PIN7                        7                       /* LED1 used in TX ISR is connected to this pin         */
#define PIN8                        8                       /* LED2 used in RX ISR is connected to this pin         */
